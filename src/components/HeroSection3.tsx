  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".tech-img", {
        ...
        opacity: 0,
        ease: "none",
        // IMPORTANTE: Evita bugs de cálculo quando há pins acima
        immediateRender: false,
        scrollTrigger: {
          trigger: containerRef.current,
          start: "top bottom", // Começa quando o topo da secção entra na tela
          end: "center center", // Termina quando chega ao meio
          scrub: 2, // Suavidade
        },
      });
      ...
      gsap.from(".nature-img", {
        ...
        opacity: 0,
        ease: "none",
        immediateRender: false, // Correção
        scrollTrigger: {
          trigger: containerRef.current,
          start: "top bottom",
          end: "center center",
        ...
        <main className="flex flex-row gap-32">
          ...
          <div className="flex flex-col items-end">
            ...
            <Image
              ...
              style={{ width: "auto", height: "auto" }} // ADICIONA ISTO
            />
          </div>
